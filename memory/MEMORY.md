...
- [2026-05-08](2026-05-08.md) — principles.md cleanup: EDIT-CONTRACT added; 16 Collaboration entries (12 trimmed + 5 promoted to peer + 1 folded) + 5 more trimmed in Engineering rigor / Tooling / Data modeling; /distill-rules sibling skill created (rules-corpus audit, restructure allowed)
