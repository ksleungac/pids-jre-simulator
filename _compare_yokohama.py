"""One-off: stack IRL Yokohama PIDS reference above the current render."""
import os
os.environ.setdefault("SDL_VIDEODRIVER", "dummy")
import pygame

REF = "lcd_references/yokohama.png"
RENDER = "_visual_iter/v_yokohama.png"
OUT = "_visual_iter/v_yokohama_compare.png"
LABEL = "RENDER"
...
y = BORDER
# Reference band + image
lbl1 = font.render("REFERENCE (IRL Yokohama PIDS)", True, WHITE)
