...
Run against the whole sobu/1217F/sta folder for validation:
    ...
    uv run data_tools/detect_sta_cut.py audio/sobu/1217F/sta --truth audio/sobu/1217F/route.json

Or single file:

    uv run data_tools/detect_sta_cut.py audio/sobu/1217F/sta/tsuga_2_gota-del-vient.mp3
"""
