...
- [ ] **Transfer-info display — GOLDEN-rule landed; 19/22 corpus ✓; 3 deferred failures.** Greedy-threshold refinement (秋葉原/成田 vs 目黒 tradeoff), Step-1 N=5 tier recalibration, promote `render_transfer` from `preview_transfers.py` to `displays/train_models/e235_1000/`. ([WIP_transfer_display.md](WIP_transfer_display.md))
